...
public class Street {
    ...
    public Street(){        //My default constructor. I initialize my fields.
        this.rightBuildings = new ArrayList<>();
        this.leftBuildings = new ArrayList<>();
        this.streetLength = 0;
    }
    ...
    /**
     * If inputs are valid, the building is added to the ArrayList
     *
     * @param var The building that is being added to the ArrayList.
     * @return The method returns true if the building is added to the ArrayList, and false if the building is not added to
     * the ArrayList.
     */
