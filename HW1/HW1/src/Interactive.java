...
////////////////////////////////////////////
            ...
            if(!myException){
                if(choose == 1)
                    ...
                    while(myBool){
                        ...
                        else if(side == 1){     //Checking inputs validity
                            if(index < 0 || index >= street.getLeftSize()){
                                System.out.println("Entered input is out of range, try again.\n");
                                continue;
                            }
                        }
                        else{       //Checking inputs validity
                            if(index < 0 || index >= street.getRightSize()){
                                System.out.println("Entered input is out of range, try again.\n");
                                continue;
                            }
                        }
    ...
    /**
     * Deleting building from the Street
     */
